...
def predictionyear_to_range(survey_year: int) -> Tuple[str, str]:
   ...
   the prediction year. We want a median 3 years 
     image starting the year before the prediction year
   and ending the year after the prediction year.
    Args
    - prediction_year: int, year at which we want to obtain a poverty prediction
    Returns
