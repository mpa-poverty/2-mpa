# TRAINING/TRAIN_MSNL.PY
#
# Description: Training loop for MSNL model training and validation.
...
def msnl_finetune(
    ...
    for epoch in range(epochs):
        train_loss, train_r2 = msnl_train_step(model=model,
                                               dataloader=train_dataloader,
                                               loss_fn=loss_fn,
                                               optimizer=optimizer,
                                               device=device,
                                               r2=r2)
        test_loss, test_r2 = msnl_val_step(model=model,
